...
import { home , userlogin , userSignup , userAddDatabase , userFromDatabase  , userProfile , userlogout , verifyEmail , verifyPage } from "../controllers/homepage.js"
...
router.route("/verify/:id").get( verifyPage).post(verifyEmail )
